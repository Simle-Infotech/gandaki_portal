...
const routes: Routes = [
  {
    ...
    children: [
      {
        path: 'guest',
        loadChildren: () => import('./DemoPages/Guest/Guest.module').then(m => m.GuestModule)
      },
      /*{
        path: 'apps',
  ...
  },
  {
    ...
    children: [
      {
        path: '',
        loadChildren: () => import('./DemoPages/Admin/Admins.module').then(m => m.AdminsModule)
      },
