...
@NgModule({
  imports: [
    ...
    TablesRoutingModule, PageTitleModule, NgApexchartsModule,AgGridModule.withComponents([]),
    MatCardModule,
    MatTabsModule,
    MatIconModule,
  ],
  declarations: [TablesComponent, TableDataEntryComponent, TableDesignerComponent, TableDetailsComponent],
  providers: [
    {
      provide:
